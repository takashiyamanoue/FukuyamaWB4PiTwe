...
//		String x=this.messageTextArea.getText();
		...
		if(firstXmltag==null) {
			firstXmltag=getBetween(x,"<head","</head>");
			if(firstXmltag!=null){
			 	String firstMetaTag=getBetween(firstXmltag,"<meta","/>");
			 	if(firstMetaTag!=null)
			 	  this.pageCharSet=this.getTagProperty(firstMetaTag, "charset");
			 	else this.pageCharSet=null;
			}
			else{
				 return null;
			}
