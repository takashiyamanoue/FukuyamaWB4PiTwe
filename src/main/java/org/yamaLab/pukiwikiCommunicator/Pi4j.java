...
//                      console.println("[ASCII DATA] " + event.getAsciiString());
                    	 ...
                    	 String el="putSendBuffer serial line error:"+e.toString();
                    	 gui.addText(el+"\n");
                  	   controller.parseCommand(el);
                         e.printStackTrace();
                     }
              }
              });
...
//						       i2c_fd=I2C.i2cOpen("/dev/i2c-0");
						    	...
						    	gui.addText("i2c-0-open error:"+e+"\n");
...
//							   i2c_fd=I2C.i2cOpen("/dev/i2c-1");
						    	...
						    	gui.addText("i2c-1-open error;"+e+"¥n");
...
//    				I2C.i2cClose(i2c_fd);
					try{
					  ...
					  gui.addText("i2c.close error...e="+e+"\n");
...
//				return ""+I2C.i2cReadByte(i2c_fd, addr,reg);				
					...
					try{
						...
						String el="Pi4J i2c.getDevice("+addr+") error e="+e;
						gui.addText(el+"\n");
					...
					try{
					   ...
					   if( rx<1 ) return "-1";				   
						...
						String el="Pi4J i2c.read-A-2("+addr+") error e="+e;
						gui.addText(el+"\n");
						   System.out.println(el);
						   //return "ERROR";
						     return "-1";
			...
			if(Util.parseKeyWord(subc, "send ", rest)){ //i2c use 0 or i2c use 1
				...
				if(Util.parseStrConst(subc, command, rest)){
					try{
						...
						String el="putSendBuffer error:"+e.toString();
						controller.parseCommand(el);
						gui.addText(el+"\n");
						e.printStackTrace();
					}
